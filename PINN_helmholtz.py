...
class PINN_GAN(nn.Module):
    def __init__(self, X0, Y0, X_f, X_t, Y_t, X_lb, X_ub, boundary, layers_G: list, layers_D: list, model_name: str="", lr: tuple=(1e-3, 2e-4), lambdas: tuple = (1,1), k: float=1.0):
        """
    ...
    def boundary(self):
        ...
        boundaries = [torch.sin(self.k*X_lb)-y_lb,torch.sin(self.k*X_ub)-y_ub]
