...
if pde=="schroedinger":
    ...
    plot_with_ground_truth(y_pred, X_star, X, T, Y_star, ground_truth_ref=False, ground_truth_refpts=[], filename = "ground_truth_comparison.png")
    # plot errors TODO apply in a general way
